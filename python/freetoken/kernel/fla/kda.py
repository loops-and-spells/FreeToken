...
from freetoken.kernel.fla.chunk_intra import chunk_kda_fwd_intra
...
from freetoken.kernel.fla.op import exp, exp2, log
...
# targets NVIDIA only (matches chunk.py).
...
# NOTE: upstream defines an rms_norm_gated wrapper over fused_norm_gate here;
# stripped on vendoring -- FreeToken ships its own in layernorm_gated.py.
@triton.autotune(
    configs=[
